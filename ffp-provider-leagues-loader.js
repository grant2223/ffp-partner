...
(function () {
  ...
  function sqResHtml(entId) {
    ...
    out += '<div class="lg-sqlist">' + (list.length ? list.map(function (p) {
      ...
      return '<div class="lg-sqrow">' + sqPhotoCell(p) + sqNoCell(p) + '<span class="nm">' + esc(p.name) + '</span>' + b + '<span class="sp"></span>' + sqPosCell(p) + sqCapCell(p) + '<span class="ms x" onclick="FFPLeague.sqRemove(\'' + p.id + '\')">close</span></div>';
  ...
  function sqNoCell(p) {
    ...
    return '<select class="lg-sel lg-sqno" title="Shirt number" onchange="FFPLeague.sqSetNo(\'' + p.id + '\',this.value)">' + o + '</select>';
  }
  function sqPosCell(p) {
    ...
    return '<select class="lg-sel lg-sqpos" onchange="FFPLeague.sqSetPos(\'' + p.id + '\',this.value)"><option value="">Covers&hellip;</option>'
  ...
  function sqCapCell(p) {
    ...
    return '<span class="lg-sqcap' + (p.captain ? ' on' : '') + '" title="Captain" onclick="FFPLeague.sqCaptain(\'' + p.id + '\',' + (p.captain ? 'false' : 'true') + ')">C</span>';
  }
